    ...
    switch (errorType) {
      case 'DriverMissing':
        return {
          ...
          reasons: [
            ...
            'Manufacturer manufacturer-specific utility is required'
          ],
          steps: [
            'Visit the official manufacturer website (HP, Epson, or Canon)',
            'Download and run the driver setup installer for your model',
            'Once installation finishes, click Retry below'
          ],
          primaryAction: {
            label: 'Download Driver & Retry',
            onClick: onRetry
          }
        };
      ...
      case 'PrinterOffline':
        return {
          ...
          description:
            'Self Print could not establish a live communication link with the printer hardware.',
          reasons: [
      ...
      case 'PaperOut':
        return {
          ...
          steps: [
            ...
            'Adjust the blue paper guides to fit the sheet edges',
      ...
      default:
        return {
          icon: AlertTriangle,
          badgeColor: 'bg-rose-50 text-rose-800 border-rose-200',
          badgeText: 'No Device Detected',
          title: 'No Compatible Printer Detected',
          description:
            "We couldn't find any connected printer on your computer ports or local network.",
          reasons: [
            'Printer power switch is turned off',
            'USB cable is unplugged or loose',
            'Wi-Fi printer is disconnected from the local network',
            'Printer driver is not installed in Windows'
          ],
          steps: [
            'Turn on your printer and check power LED',
            'Reconnect the USB cable securely to your computer',
            'Ensure your printer and PC are on the same Wi-Fi / LAN',
            'Install manufacturer drivers or configure manually'
          ],
          primaryAction: {
            label: 'Scan Again',
            onClick: onRetry
