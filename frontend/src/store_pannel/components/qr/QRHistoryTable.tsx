...
import { RefreshCw, Download, Printer, Trash2 } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 font-normal mt-0.5">
            View and manage previously generated QR codes
          </p>
        </div>

        <button
          onClick={onRegenerate}
          className="self-start sm:self-auto px-4 py-2 rounded-xl border border-indigo-200 bg-indigo-50/50 hover:bg-indigo-50 text-indigo-600 text-xs font-semibold flex items-center gap-1.5 transition-colors shadow-sm"
        >
