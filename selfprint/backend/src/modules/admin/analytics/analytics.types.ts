...
export interface AdminAnalyticsDashboardResponse {
  ...
  printingActivity: PrintingActivityDataPoint[];
  platformHealth: PlatformHealthMetric;
  heatmapCells: HeatmapCell[];
  topStores: AnalyticsTopStoreItem[];
  paperUsage: PaperUsageItem[];
  printTypeSegments: PrintTypeSegment[];
  printerStatusSegments: PrinterStatusSegment[];
