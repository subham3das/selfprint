              ...
              Array.from({ length: 5 }).map((_, idx) => (
                <tr key={`store-skel-${idx}`} className="animate-pulse">
                  ...
                  <td className="py-2.5 px-2 text-right">
                    <div className="w-14 h-3 bg-slate-200 rounded ml-auto" />
                  </td>
                  <td className="py-2.5 px-2 text-right">
                    <div className="w-8 h-3 bg-slate-100 rounded ml-auto" />
                  </td>
                  <td className="py-2.5 px-2 text-right">
                    <div className="w-12 h-3 bg-slate-100 rounded ml-auto" />
                  </td>
                  <td className="py-2.5 pl-2 text-right">
                    <div className="w-12 h-4 bg-slate-100 rounded-full ml-auto" />
                  </td>
                </tr>
              ))
            ) : stores.length === 0 ? (
